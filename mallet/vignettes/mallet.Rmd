...
Depending of the size of your data it can be so that you need increase the Java virtual machine heap memory to handle larger corpuses. To do this you need to set the ```Xmx```flag to the memory size you want to be allocated. Below is an example of allocating 4 gB. 
